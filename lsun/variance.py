...
"""
Variance-Regularized Adversarial Learning for LSUN Bedroom dataset.
"""
...
if __name__ == '__main__':
    ...
    out_dir = '/u/grewalka/lsun/variance/%d_%d_%d_1/' % (params['iters_F'], params['iters_R'], params['iters_D'])
    ...
    stream, num_examples = load(params['batch_size'], downsample=False)
    ...
    for epoch in range(params['epochs']):
        ...
        # Training
        for i in range(num_examples / params['batch_size']): # num_examples / batch_size = num_batches
            ...
            stream, num_examples = load(params['batch_size'], downsample=False)[0]
