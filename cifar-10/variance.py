...
if __name__ == '__main__':
    ...
    out_dir = '/u/grewalka/cifar10/variance/bn_g/%d_%d_%d_1/' % (params['iters_F'], params['iters_R'], params['iters_D'])
    ...
    z_samples = np.float32(np.random.normal(size=(params['batch_size'],params['dim_z'])))
