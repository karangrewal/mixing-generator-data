...
if __name__ == '__main__':
    if BN_D and BN_G:
        out_dir = '/u/grewalka/cifar10/least_squares/%d_1/' % (ITERS_D)
    elif BN_D:
        out_dir = '/u/grewalka/cifar10/least_squares/bn_d/%d_1/' % (ITERS_D)
    elif BN_G:
        out_dir = '/u/grewalka/cifar10/least_squares/bn_g/%d_1/' % (ITERS_D)
    else:
        out_dir = '/u/grewalka/cifar10/least_squares/nbn/%d_1/' % (ITERS_D)
