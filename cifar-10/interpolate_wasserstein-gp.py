...
"""
WGAN-GP interpolation experiment.
"""
...
if __name__ == '__main__':
    ...
    out_dir = '/u/grewalka/cifar10/gamma-experiment/wasserstein-gp/%d_1/' % (params['discriminator_iters'])
        ...
        for epoch in range(params['epochs']):
            ...
            for i in range(num_examples / params['batch_size']):
                ...
                for k in range(params['discriminator_iters']):
                    ...
                    x_i = iterator.next()[0]
                    z_i = np.float32(np.random.normal(size=(params['batch_size'],params['dim_z'])))
                    train_D(x_i, z_i, np.random.uniform())
